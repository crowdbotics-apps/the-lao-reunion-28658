...
## Project Structure
    ...
    ├── the_lao_reunion_28658  # Django project configurations
...
1. Clone this repo and `cd the_lao_reunion_28658`
...
2. Clone this repo and `cd the_lao_reunion_28658`
